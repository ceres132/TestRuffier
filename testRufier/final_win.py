...
class FinalWin(QWidget):
    ...
    def results(self):
        ...
        if self.exp.age == 11 or self.exp.age == 12:
            if self.index >=18:
                ...
                return txt_res3
            elif self.index <9 and self.index >=2:
                return txt_res4
            else:
                return txt_res5
    ...
    def initUI(self):
        ...
        self.lauout_line  = QVBoxLayout()
        self.lauout_line.addWidget(self.index_text, alignment = Qt.AlignCenter)
        self.lauout_line.addWidget(self.work_text, alignment = Qt.AlignCenter)
        self.setLayout(self.lauout_line)
